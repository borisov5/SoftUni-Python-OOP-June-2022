...
class TestHashTable(TestCase):
    ...
    def test_set_item_collision_liner_approach_is_taken(self):
        table = HashTable()
        table["name"] = "Peter"
    ...
    def test_set_item_dunder_linear_approach_starts_at_the_beggining_when_reaches_end(self):
        table = HashTable()
        table["name"] = "Test"
        table["age"] = 0
        table["is_pet_owner"] = True
